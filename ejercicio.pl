El britanico vive en la casa roja                              --> "britanico" es una constante de individuo
El sueco tiene un perro como mascota                           --> "sueco" es una constante de individuo
El danes toma te                                               --> "danes" es una constante de individuo
El noruego vive en la primera casa                             --> "noruego" es una constante de individuo
El aleman fuma prince                                          --> "aleman" es una constante de individuo
La casa verde esta a la izquierda de la blanca                 --> 
El dueño de la casa verde bebe cafe                            -->
El propietario que fuma pall mall cria pajaros                 -->
El dueño de la casa amarilla fuma dunhill                      -->
El hombre que vive en la casa del centro bebe leche            -->
El que fuma blends vive al lado del que tiene un gato          -->
El que tiene un caballo vive al lado del que fuma dunhill      -->
